...
export default function CartComponent() {
    ...
    function sendMail(){
        ...
        const data = {
            ...
            totalPrice : precioTotal,  //completar. Está todo en "datosEnMiBD"
        }
  ...
  return (
    ...
    <div id="Cart">
        ...
        <div id="flex-total">
            <h1><span id="total-price">{precioTotal >= 500 ? "Total with shipping" : "Total"}</span> ${precioTotal}</h1>
            <button id="final-button" onClick={()=> sendMail()}>Buy</button>
        </div>
    </div> 
  )
}
