...
const BransSearched = ({ info }) => {
  ...
  // console.log("SOY PARAMAS:", params);
  // console.log("SOY ESTADO GLOBAL BRAND:", Brand);
  ...
  // console.log("SOY BRANDS_PRODUCTS", brandProducts);
  ...
  return (
    <div id="Contenido">
      ...
      />
      <section id="Products">
        <Filter info={info} /> {/* info={info} order={order} */}
